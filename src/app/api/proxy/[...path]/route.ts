...
const PARTNER_BASE_URL = 'https://platform.lazypay.com/partner';
...
const BK_API_BASE = 'https://bk-api.lazypay.com/sp/api';
...
async function proxyRequest(
  ...
  if (bkApiPath) {
    ...
    try {
      const fetchInit: RequestInit = { method: request.method };
