    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Content */}
          <div className="flex-1 min-h-0 overflow-y-auto overscroll-contain px-5 py-5 bg-white">
          ...
          {/* Footer CTA */}
          <div className="flex-shrink-0 px-5 py-4 border-t border-slate-100 bg-white safe-area-inset-bottom">
            <Link
              to="/card-genius"
              onClick={onClose}
